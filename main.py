...
def main(args=None):
    ...
    # 从默认文件夹tests开始查找测试用例
    case_finder = DiscoverTestCases(options.test_targets) if options.test_targets else DiscoverTestCases()
    # 查找测试模块并导入
...
if __name__ == "__main__":
    ...
    main("-env prod -i smoke -t ./tests/test_one.py -n 8")
    # main()
    ...
    print(cases_run_success, cases_run_fail, cases_encounter_error, skipped_cases)